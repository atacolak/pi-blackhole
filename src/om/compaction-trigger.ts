			...
			try {
				...
				ctx.compact({
					onComplete: (result: any) => {
						...
						// The before-compact hook emits its own detailed toast
						// ("blackhole: N entries processed") via session_compact,
						// so we don't fire a duplicate "compaction complete" here.
					},
